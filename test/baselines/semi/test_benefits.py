...
from veniq.baselines.semi.benefits import lcom2
...
class BenefitTest(TestCase):
    ...
    def test_1(self):
        example_1 = (3, 14)
        original_value = lcom2(self.dict_semantic)
        opportunity_value_1 = lcom2(self.dict_semantic, example_1, 'opportunity')
        original_after_ref_value_1 = lcom2(self.dict_semantic, example_1, 'after_ref')
    ...
    def test_2(self):
        ...
        def _get_benefit(dict_semantic: Dict[str, List[str]], range_stats: Tuple[int, int]) -> int:
