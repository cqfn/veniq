...
with ProcessPool(system_cores_qty) as executor:
    ...
    for filename in tqdm(dir_to_analyze):
        next(result)
        # for folder in new_dataset:
        #     command = ['RefactorMiner', '-a', folder]
